package com.alextrandafir.fx.jobs.config;

import com.alextrandafir.fx.jobs.RatesUpdateJob;
...
public class SchedulerConfig {
    ...
    public JobDetailFactoryBean jobDetail() {
        ...
        jobDetailFactory.setJobClass(RatesUpdateJob.class);
    ...
    public SimpleTriggerFactoryBean trigger(JobDetail job) {
        ...
        int frequencyInSec = jobIntervalSeconds;
